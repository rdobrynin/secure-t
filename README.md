...
Давайте напишем скрипт на Python, который наглядно покажет, почему мы отказываемся от ECC, но оставляем AES.
...
![Криптография_8.png](hybrid_tls_diagram.png)
...
| Сценарий атаки | ECDH (X25519) | ML-KEM (Kyber) | Результат (гибрид) |
|---|---|---|---|
| Классический взлом (сегодня) | ✅ Стойкий | ✅ Стойкий | ✅ БЕЗОПАСНО |
| Математический провал Kyber | ✅ Стойкий | ❌ Взломан | ✅ БЕЗОПАСНО (спасает ECDH) |
| Квантовый компьютер (2030+) | ❌ Взломан | ✅ Стойкий | ✅ БЕЗОПАСНО (спасает Kyber) |
